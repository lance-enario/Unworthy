...
public class General_Lich extends Entity{
    ...
    public void getImage(){
        up1 = setup("/General/Lich/walk/lich_walk_00", 20, 20);
        up2 = setup("/General/Lich/walk/lich_walk_01", 20, 20);
        down1 = setup("/General/Lich/walk/lich_walk_02", 20, 20);
        down2 = setup("/General/Lich/walk/lich_walk_03", 20, 20);
        left1 = setup("/General/Lich/walk/lich_walk_04", 20, 20);
        left2 = setup("/General/Lich/walk/lich_walk_05", 20, 20);
        right1 = setup("/General/Lich/walk/lich_walk_06", 20, 20);
        right2 = setup("/General/Lich/walk/lich_walk_07", 20, 20);
    }
